...
public struct LanguageSpec: Sendable {
    ...
    public init(
        ...
        strings: [StringDelim] = [],
        charLiteral: Character? = nil,
        keywords: Set<String> = [],
        keywordsCaseInsensitive: Bool = false,
        declKeywords: [String: SyntaxKind] = [:],
        hashDirectives: Bool = false,
        hashDirectivesAnchored: Bool = true,
        atWords: Bool = false,
        rustAttributes: Bool = false,
        capitalizedIsType: Bool = false,
        shellVars: Bool = false,
        memberAccess: Bool = true,
        headerStrings: Bool = false
    ) {
        self.name = name
...
public struct StringDelim: Sendable {
    ...
    public init(open: String, close: String? = nil, escape: Character? = "\\", multiline: Bool = false) {
        self.open = open
