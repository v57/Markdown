  ...
  public final class EditorLayoutManager: EditorLayoutManagerCore {
    ...
    public override func drawCodeBlockBackground(union: CGRect, at origin: CGPoint) {
      let path = UIBezierPath(
        roundedRect: union, cornerRadius: MarkdownMetrics.standard.codeBlockCornerRadius)
    ...
    public override func drawQuoteBarHook(bar: CGRect) {
      let path = UIBezierPath(
        roundedRect: bar, cornerRadius: MarkdownMetrics.standard.quoteBarCornerRadius)
    ...
    public override func codeTextColor() -> PlatformColor {
      MarkdownUIKitStyle.standard.color(.secondaryLabel)
    }
    public override func codeBlockBackgroundColor() -> PlatformColor {
      MarkdownUIKitStyle.standard.color(.quaternarySystemFill)
    }
    ...
    public override func inlineCodeStrokeColor() -> PlatformColor {
      .label.withAlphaComponent(0.05)
    }
    public override func quoteBarColor() -> PlatformColor {
      MarkdownUIKitStyle.standard.color(.systemRed)
    }
    public override func ruleColor() -> PlatformColor {
