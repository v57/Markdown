...
public struct MarkdownMetrics: Sendable {
    ...
    public func listParagraph(level: Int, markerWidth: CGFloat) -> MarkdownParagraph {
        ...
        return MarkdownParagraph(
            paragraphSpacing: listParagraphSpacing,
    ...
    public func quoteParagraph() -> MarkdownParagraph {
        MarkdownParagraph(paragraphSpacing: quoteParagraphSpacing, firstLineHeadIndent: quoteIndent, headIndent: quoteIndent)
    }
...
#if DEBUG
#Preview("MarkdownEditorView") {
  MarkdownEditorView().frame(minWidth: 480, minHeight: 800)
}
#endif
